...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------#
    mode = "predict_image" # 照片预测
    # mode = "predict_video" # 视频预测
    #-------------------------------------------------------------------------#
    ...
    if mode == "predict_image":
        ...
        while True:
            ...
            try:
                ...
                # r_image.show()
                print("out_putok")
                r_image.save("img/output/1.jpg")
                # r_image.save("img/all_test5.jpg")
